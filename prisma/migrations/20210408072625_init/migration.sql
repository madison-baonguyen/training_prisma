...
CREATE TABLE `CourseEnrollment` (
    ...
    `courseId` INTEGER NOT NULL,
INDEX `CourseEnrollment.userId_role_index`(`userId`, `role`),
...
-- AddForeignKey
ALTER TABLE `TestResult` ADD FOREIGN KEY (`studenId`) REFERENCES `User`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
